...
r=[(-s[0].x+6*s[1].x+s[2].x)/6,(-s[0].y+6*s[1].y+s[2].y)/6,(s[1].x+6*s[2].x-s[3].x)/6,(s[1].y+6*s[2].y-s[3].y)/6,s[2].x,s[2].y]}return r}function r(t,e,r,n){return[t,e,r,n,r,n]}function n(t,e,r,n,i,o){return[1/3*t+2/3*r,1/3*e+2/3*n,1/3*i+2/3*r,1/3*o+2/3*n,i,o]}function i(t,e,r,n,o,s,a,p,h,l){var c,u=120*Math.PI/180,d=Math.PI/180*(+o||0),f=[],g=Graph.memoize(function(t,e,r){return{x:t*Math.cos(r)-e*Math.sin(r),y:t*Math.sin(r)+e*Math.cos(r)}});if(l)k=l[0],C=l[1],_=l[2],w=l[3];else{c=g(t,e,-d),t=c.x,e=c.y,c=g(p,h,-d),p=c.x,h=c.y;var y=(Math.cos(Math.PI/180*o),Math.sin(Math.PI/180*o),(t-p)/2),v=(e-h)/2,m=y*y/(r*r)+v*v/(n*n);m>1&&(m=Math.sqrt(m),r*=m,n*=m);var x=r*r,b=n*n,G=(s==a?-1:1)*Math.sqrt(Math.abs((x*b-x*v*v-b*y*y)/(x*v*v+b*y*y))),_=G*r*v/n+(t+p)/2,w=G*-n*y/r+(e+h)/2,k=Math.asin(((e-w)/n).toFixed(9)),C=Math.asin(((h-w)/n).toFixed(9));k=t<_?Math.PI-k:k,C=p<_?Math.PI-C:C,k<0&&(k=2*Math.PI+k),C<0&&(C=2*Math.PI+C),a&&k>C&&(k-=2*Math.PI),!a&&C>k&&(C-=2*Math.PI)}var S=C-k
;if(Math.abs(S)>u){var T=C,E=p,A=h;C=k+u*(a&&C>k?1:-1),p=_+r*Math.cos(C),h=w+n*Math.sin(C),f=i(p,h,r,n,o,0,a,E,A,[C,T,_,w])}S=C-k;var D=Math.cos(k),M=Math.sin(k),z=Math.cos(C),P=Math.sin(C),L=Math.tan(S/4),R=4/3*r*L,O=4/3*n*L,V=[t,e],B=[t+R*M,e-O*D],H=[p+R*P,h-O*z],I=[p,h];if(B[0]=2*V[0]-B[0],B[1]=2*V[1]-B[1],l)return[B,H,I].concat(f);f=[B,H,I].concat(f).join().split(",");for(var N=[],q=0,J=f.length;q<J;q++)N[q]=q%2?g(f[q-1],f[q],d).y:g(f[q],f[q+1],d).x;return N}function o(t,e,r){var n,i,o,s,a,p,h,l,c,u,d,f,g,y,v,m,x,b=t.curve().segments,G=b.length,_=e.curve().segments,w=_.length,k=r?0:[];for(v=0;v<G;v++)if(g=b[v],"M"==g[0])n=a=g[1],i=p=g[2];else for("C"==g[0]?(c=[["M",n,i],g],d=[n,i].concat(g.slice(1)),n=g[5],i=g[6]):(c=[["M",n,i],["C",n,i,a,p,a,a]],d=[n,i,n,i,a,p,a,p],n=a,i=p),m=0;m<w;m++)if(y=_[m],"M"==y[0])o=h=y[1],s=l=y[2];else if("C"==y[0]?(u=[["M",o,s],y],f=[o,s].concat(y.slice(1)),o=y[5],s=y[6]):(u=[["M",o,s],["C",o,s,h,l,h,l]],f=[o,s,o,s,h,l,h,l],o=h,s=l),
r)k+=Graph.util.curveIntersection(d,f,!0);else{x=Graph.util.curveIntersection(d,f);for(var C=0,S=x.length;C<S;C++)x[C].segment1=v,x[C].segment2=m,x[C].bezier1=c,x[C].bezier2=u;k=k.concat(x)}return k}var s=Graph.lang.Path=function(t){var e=[];e=Graph.isPath(t)?_.cloneDeep(t.segments):_.isArray(t)?_.cloneDeep(t):_.cloneDeep(Graph.util.path2segments(t)),this.segments=e};s.options={segments:[]},s.extend=Graph.lang.Class.extend,s.prototype.constructor=s,s.prototype.command=function(){return Graph.util.segments2path(this.segments)},s.prototype.absolute=function(){if(!this.segments.length)return new s([["M",0,0]]);var t=Graph.lookup(this.toString(),"absolute",this.toValue()),r=this.segments;if(t.absolute)return t.absolute;var n=[],i=0,o=0,a=0,p=0,h=0;"M"==r[0][0]&&(i=+r[0][1],o=+r[0][2],a=i,p=o,h++,n[0]=["M",i,o]);for(var l,c,u,d=3==r.length&&"M"==r[0][0]&&"R"==r[1][0].toUpperCase()&&"Z"==r[2][0].toUpperCase(),f=h,g=r.length;f<g;f++){if(n.push(c=[]),u=r[f],
u[0]!=_.toUpper(u[0]))switch(c[0]=_.toUpper(u[0]),c[0]){case"A":c[1]=u[1],c[2]=u[2],c[3]=u[3],c[4]=u[4],c[5]=u[5],c[6]=+(u[6]+i),c[7]=+(u[7]+o);break;case"V":c[1]=+u[1]+o;break;case"H":c[1]=+u[1]+i;break;case"R":l=_.concat([i,o],u.slice(1));for(var y=2,v=l.length;y<v;y++)l[y]=+l[y]+i,l[++y]=+l[y]+o;n.pop(),n=_.concat(n,[["C"].concat(e(l,d))]);break;case"M":a=+u[1]+i,p=+u[2]+o;default:for(var m=1,x=u.length;m<x;m++)c[m]=+u[m]+(m%2?i:o)}else if("R"==u[0])l=_.concat([i,o],u.slice(1)),n.pop(),n=_.concat(n,[["C"].concat(e(l,d))]),c=_.concat(["R"],u.slice(-2));else for(var b=0,G=u.length;b<G;b++)c[b]=u[b];switch(c[0]){case"Z":i=a,o=p;break;case"H":i=c[1];break;case"V":o=c[1];break;case"M":a=c[c.length-2],p=c[c.length-1];default:i=c[c.length-2],o=c[c.length-1]}}return t.absolute=n=new s(n),n},s.prototype.start=function(){return this.pointAt(0)},s.prototype.end=function(){return this.pointAt(this.length())},s.prototype.head=function(){},s.prototype.tail=function(){},
s.prototype.relative=function(){var t=Graph.lookup(this.toString(),"relative",this.toValue()),e=this.segments;if(t.relative)return t.relative;var r=[],n=0,i=0,o=0,a=0,p=0;"M"==e[0][0]&&(n=e[0][1],i=e[0][2],o=n,a=i,p++,r.push(["M",n,i]));for(var h=p,l=e.length;h<l;h++){var c=r[h]=[],u=e[h];if(u[0]!=_.toLower(u[0]))switch(c[0]=_.toLower(u[0]),c[0]){case"a":c[1]=u[1],c[2]=u[2],c[3]=u[3],c[4]=u[4],c[5]=u[5],c[6]=+(u[6]-n).toFixed(3),c[7]=+(u[7]-i).toFixed(3);break;case"v":c[1]=+(u[1]-i).toFixed(3);break;case"m":o=u[1],a=u[2];default:for(var d=1,f=u.length;d<f;d++)c[d]=+(u[d]-(d%2?n:i)).toFixed(3)}else{c=res[h]=[],"m"==u[0]&&(o=u[1]+n,a=u[2]+i);for(var g=0,y=u.length;g<y;g++)res[h][g]=u[g]}var v=r[h].length;switch(r[h][0]){case"z":n=o,i=a;break;case"h":n+=+r[h][v-1];break;case"v":i+=+r[h][v-1];break;default:n+=+r[h][v-2],i+=+r[h][v-1]}}return t.relative=r=new s(r),r},s.prototype.curve=function(){var e=Graph.lookup(this.toString(),"curve",this.toValue());if(e.curve)return e.curve
;for(var r=_.cloneDeep(this.absolute().segments),n={x:0,y:0,bx:0,by:0,X:0,Y:0,qx:null,qy:null},i=[],o="",a="",p=0,h=r.length;p<h;p++){r[p]&&(o=r[p][0]),"C"!=o&&(i[p]=o,p&&(a=i[p-1])),r[p]=t(r[p],n,a),"A"!=i[p]&&"C"==o&&(i[p]="C"),function(t,e){if(t[e].length>7){t[e].shift();for(var n=t[e];n.length;)i[e]="A",t.splice(e++,0,["C"].concat(n.splice(0,6)));t.splice(e,1),h=r.length}}(r,p);var l=r[p],c=l.length;n.x=l[c-2],n.y=l[c-1],n.bx=_.float(l[c-4])||n.x,n.by=_.float(l[c-3])||n.y}return e.curve=new s(r),e.curve},s.prototype.curve2curve=function(e){function r(t,e,r,o,s){t&&e&&"M"==t[s][0]&&"M"!=e[s][0]&&(e.splice(s,0,["M",o.x,o.y]),r.bx=0,r.by=0,r.x=t[s][1],r.y=t[s][2],d=_.max([n.length,i&&i.length||0]))}for(var n=_.cloneDeep(this.absolute().segments),i=_.cloneDeep(new s(e).absolute().segments),o={x:0,y:0,bx:0,by:0,X:0,Y:0,qx:null,qy:null},a={x:0,y:0,bx:0,by:0,X:0,Y:0,qx:null,qy:null},p=[],h=[],l="",c="",u=0,d=_.max([n.length,i.length]);u<d;u++){n[u]&&(l=n[u][0]),"C"!=l&&(p[u]=l,
u&&(c=p[u-1])),n[u]=t(n[u],o,c),"A"!=p[u]&&"C"==l&&(p[u]="C"),function(t,e){if(t[e].length>7){t[e].shift();for(var r=t[e];r.length;)p[e]="A",h[e]="A",t.splice(e++,0,["C"].concat(r.splice(0,6)));t.splice(e,1),d=_.max([n.length,i.length])}}(n,u),i[u]&&(l=i[u][0]),"C"!=l&&(h[u]=l,u&&(c=h[u-1])),i[u]=t(i[u],attrs2,pcom),"A"!=h[u]&&"C"==l&&(h[u]="C"),fixArc2(i,u),r(n,i,o,a,u),r(i,n,a,o,u);var f=n[u],g=i[u],y=f.length,v=g.length;o.x=f[y-2],o.y=f[y-1],o.bx=_.float(f[y-4])||o.x,o.by=_.float(f[y-3])||o.y,a.bx=_.float(g[v-4])||a.x,a.by=_.float(g[v-3])||a.y,a.x=g[v-2],a.y=g[v-1]}return[new s(n),new s(i)]},s.prototype.bbox=function(){if(!this.segments.length)return Graph.bbox({x:0,y:0,width:0,height:0,x2:0,y2:0});var t=Graph.lookup(this.toString(),"bbox",this.toValue());if(t.bbox)return t.bbox;for(var e,r=this.curve().segments,n=0,i=0,o=[],s=[],a=0,p=r.length;a<p;a++)if(e=r[a],"M"==e[0])n=e[1],i=e[2],o.push(n),s.push(i);else{var h=Graph.util.curvebox(n,i,e[1],e[2],e[3],e[4],e[5],e[6])
;o=o.concat(h.min.x,h.max.x),s=s.concat(h.min.y,h.max.y),n=e[5],i=e[6]}var l=_.min(o),c=_.min(s),u=_.max(o),d=_.max(s),f=u-l,g=d-c,y={x:l,y:c,x2:u,y2:d,width:f,height:g,cx:l+f/2,cy:c+g/2};return t.bbox=Graph.bbox(y),t.bbox},s.prototype.transform=function(t){if(t){var e=Graph.lookup(this.toString(),"transform",this.toValue(),t.toValue());if(e.transform)return e.transform;var r,n,i,o,a,p,h,l=_.cloneDeep(this.curve().segments);for(i=0,o=l.length;i<o;i++)for(h=l[i],a=1,p=h.length;a<p;a+=2)r=t.x(h[a],h[a+1]),n=t.y(h[a],h[a+1]),h[a]=r,h[a+1]=n;return e.transform=new s(l),e.transform}},s.prototype.lengthAt=function(t){},s.prototype.pointAt=function(t,e){var r,n,i,o,s,a,p,h=this.curve().segments;e=_.defaultTo(e,!1),s=0;for(var l=0,c=h.length;l<c;l++)if(n=h[l],"M"==n[0])i=n[1],o=n[2];else{if(a=Graph.curve([["M",i,o],n]),p=a.length(),s+p>t)return r=a.pointAt(a.t(t-s),e),a=null,r;s+=p,i=n[5],o=n[6],a=null}return a=Graph.curve([["M",i,o],n]),r=a.pointAt(1,e),a=null,r},
s.prototype.segmentAt=function(t){var e,r,n,i,o=this.curve().segments,s=-1,a=0;return _.forEach(o,function(o,p){if("M"==o[0])e=o[1],r=o[2];else{if(i=Graph.curve([["M",e,r],o]),e=i.x(),r=i.y(),(n=i.length())+a>t)return s=p,!1;a+=n,i=null}}),s},s.prototype.length=function(){var t,e,r,n,i,o=this.curve().segments;n=0;for(var s=0,a=o.length;s<a;s++)t=o[s],"M"==t[0]?(e=t[1],r=t[2]):(i=Graph.curve([["M",e,r],t]),n+=i.length(),e=t[5],r=t[6],i=null);return n},s.prototype.slice=function(t,e){var r,n,i,o,s,a,p,h,l=this.curve().segments,c={};a=0,n="";for(var u=0,d=l.length;u<d;u++)i=l[u],"M"==i[0]?(o=i[1],s=i[2]):(p=Graph.curve([["M",o,s],i]),h=p.length(),a+h>length&&(r=p.pointAt(p.t(length-a)),n+=["C"+r.start.x,r.start.y,r.m.x,r.m.y,r.props.x,r.props.y],c.start=Graph.path(n),n=["M"+r.props.x,r.props.y+"C"+r.n.x,r.n.y,r.end.x,r.end.y,i[5],i[6]].join()),a+=h,o=i[5],s=i[6],p=null),n+=i.shift()+i;return c.end=Graph.path(n),c},s.prototype.vertices=function(){
var t=Graph.lookup(this.toString(),"vertices",this.toValue());if(t.vertices)return t.vertices;var e=this.segments,r=[];return _.forEach(e,function(t){var e,n,i=t.length;"Z"!=t[0]&&("M"==t[0]?(e=t[1],n=t[2]):(e=t[i-2],n=t[i-1]),r.push(Graph.point(e,n)))}),t.vertices=r,t.vertices},s.prototype.addVertext=function(t){var e,r,n,i,o=this.isSimple(),s=o?_.cloneDeep(this.segments):this.curve().segments,a=-1,p=t.props.x,h=t.props.y,l=0,c=0;return _.forEach(s,function(t,o){if("Z"!=t[0])if("M"==t[0])e=t[1],r=t[2];else if("L"==t[0]?(n=Graph.curve([["M",e,r],["C",e,r,e,r,t[1],t[2]]]),e=t[1],r=t[2]):(n=Graph.curve([["M",e,r],t]),e=n.x(),r=n.y()),i=n.clone(),i.segments[1][5]=p,i.segments[1][6]=h,l+=n.length(),(c+=i.length())<=l)return a=o,!1}),a>-1&&(o?s.splice(a,0,["L",p,h]):s.splice(a,0,["C",p,h,p,h,p,h]),this.segments=s),this},s.prototype.intersect=function(t){return o(this,t,!0)>0},s.prototype.intersection=function(t,e){var r=o(this,t);return e?r:_.map(r,function(t){var e=Graph.point(t.x,t.y)
;return e.segment1=t.segment1,e.segment2=t.segment2,e.bezier1=t.bezier1,e.bezier2=t.bezier2,e})},s.prototype.intersectnum=function(t){return o(this,t,!0)},s.prototype.alpha=function(t){},s.prototype.contains=function(t){var e,r,n,i,o;return i=t.props.x,o=t.props.y,e=this.bbox(),n=e.toJson(),r=new s([["M",i,o],["H",n.x2+10]]),e.contains(t)&&this.intersectnum(r)%2==1},s.prototype.nearest=function(t){var e,r,n,i,o,s=this.length(),a=20,p=1/0,h=Graph.util.taxicab;for(Graph.isPoint(t)&&(t=t.toJson()),o=0;o<s;o+=a)n=this.pointAt(o,!0),(i=h(n,t))<p&&(p=i,e=n,r=o);a/=2;for(var l,c,u,d,f,g;a>.5;)(u=r-a)>=0&&(f=h(l=this.pointAt(u,!0),t))<p?(e=l,r=u,p=f):(d=r+a)<=s&&(g=h(c=this.pointAt(d,!0),t))<p?(e=c,r=d,p=g):a/=2;return e.distance=r,e},s.prototype.isSimple=function(){var t=!0;return _.forEach(this.segments,function(e){if(!/[MLZ]/i.test(e[0]))return t=!1,!1}),t},s.prototype.moveTo=function(t,e){var r=this.segments;return r.length?(r[0][0]="M",r[0][1]=t,r[0][2]=e):r=[["M",t,e]],this},
s.prototype.lineTo=function(t,e,r){var n=this.segments;if(r=_.defaultTo(r,!0),n){var i=n.length-1;"M"==n[i][0]||r?n.push(["L",t,e]):(n[i][1]=t,n[i][2]=e)}return this},s.prototype.toString=function(){return"Graph.lang.Path"},s.prototype.toValue=function(){return Graph.util.segments2path(this.segments)},s.prototype.toArray=function(){return this.segments},s.prototype.clone=function(){var t=[];return _.forEach(this.segments,function(e){t.push(e.slice())}),new s(t)},Graph.isPath=function(t){return t instanceof Graph.lang.Path},Graph.path=function(t){return new Graph.lang.Path(t)}}(),function(){var t=Graph.lang.Matrix=function(t,e,r,n,i,o){this.props={},this.props.a=_.defaultTo(t,1),this.props.b=_.defaultTo(e,0),this.props.c=_.defaultTo(r,0),this.props.d=_.defaultTo(n,1),this.props.e=_.defaultTo(i,0),this.props.f=_.defaultTo(o,0)};t.options={props:{a:1,b:0,c:0,d:1,e:0,f:0}},t.extend=Graph.lang.Class.extend,t.prototype.constructor=t,t.prototype.x=function(t,e){
return t*this.props.a+e*this.props.c+this.props.e},t.prototype.y=function(t,e){return t*this.props.b+e*this.props.d+this.props.f},t.prototype.get=function(t){return+this.props[t].toFixed(4)},t.prototype.multiply=function(t,e,r,n,i,o){var s,a,p,h,l=[[],[],[]],c=[[this.props.a,this.props.c,this.props.e],[this.props.b,this.props.d,this.props.f],[0,0,1]],u=[[t,r,i],[e,n,o],[0,0,1]];for(Graph.isMatrix(t)&&(u=[[t.props.a,t.props.c,t.props.e],[t.props.b,t.props.d,t.props.f],[0,0,1]]),s=0;s<3;s++)for(a=0;a<3;a++){for(h=0,p=0;p<3;p++)h+=c[s][p]*u[p][a];l[s][a]=h}return this.props.a=l[0][0],this.props.b=l[1][0],this.props.c=l[0][1],this.props.d=l[1][1],this.props.e=l[0][2],this.props.f=l[1][2],this},t.prototype.invert=function(t){var e,r,n,i,o,s,a=this.props.a*this.props.d-this.props.b*this.props.c;return t=_.defaultTo(t,!1),e=this.props.d/a,r=-this.props.b/a,n=-this.props.c/a,i=this.props.a/a,o=(this.props.c*this.props.f-this.props.d*this.props.e)/a,
s=(this.props.b*this.props.e-this.props.a*this.props.f)/a,t?new Graph.matrix(e,r,n,i,o,s):(this.props.a=e,this.props.b=r,this.props.c=n,this.props.d=i,this.props.e=o,this.props.f=s,this)},t.prototype.translate=function(t,e){return t=_.defaultTo(t,0),e=_.defaultTo(e,0),this.multiply(1,0,0,1,t,e),this},t.prototype.rotate=function(t,e,r){if(!arguments.length){var n,i,o=this.delta(0,1);return this.delta(1,0),n=180/Math.PI*Math.atan2(o.y,o.x)-90,i=Graph.util.rad(n),{deg:n,rad:i,sin:Math.sin(i),cos:Math.cos(i)}}var s;s=Graph.util.rad(t),e=_.defaultTo(e,0),r=_.defaultTo(r,0);var a=+Math.cos(s).toFixed(9),p=+Math.sin(s).toFixed(9);return this.multiply(a,p,-p,a,e,r),this.multiply(1,0,0,1,-e,-r),this},t.prototype.scale=function(t,e,r,n){if(void 0===t){var i=this.props,t=Graph.util.hypo(i.a,i.b),e=Graph.util.hypo(i.c,i.d);return this.determinant()<0&&(t=-t),{x:t,y:e}}return e=_.defaultTo(e,t),(r||n)&&(r=_.defaultTo(r,0),n=_.defaultTo(n,0)),(r||n)&&this.multiply(1,0,0,1,r,n),
...
i.push(e.x+e.width),o.push(e.y+e.height);return r=_.min(r),n=_.min(n),i=_.max(i),o=_.max(o),Graph.bbox({x:r,y:n,x2:i,y2:o,width:i-r,height:o-n})},t.prototype.toArray=function(){return _.map(this.items,function(t){return Graph.registry.vector.get(t)})},t.prototype.toString=function(){return"Graph.collection.Vector"};var e=["attr","remove"];_.forEach(e,function(e){!function(e){t.prototype[e]=function(){var t=_.toArray(arguments);return this.each(function(r){r[e].apply(r,t)}),this}}(e)})}(),function(){var t=Graph.collection.Shape=function(t){this.items=_.map(t,function(t){return t.guid()}),t=null};t.prototype.constructor=t,t.prototype.keys=function(){return this.items.slice()},t.prototype.size=function(){return this.items.length},t.prototype.index=function(t){var e=t.guid();return _.indexOf(this.items,e)},t.prototype.has=function(t){var e=t.guid();return-1!==_.indexOf(this.items,e)},t.prototype.find=function(t){var e=this.toArray();return _.find(e,t)},t.prototype.push=function(t){
var e=this;return _.isArray(t)?_.forEach(t,function(t){var r=t.guid();e.items.push(r)}):e.items.push(t.guid()),e.items.length},t.prototype.pop=function(){var t=this.items.pop();return Graph.registry.shape.get(t)},t.prototype.shift=function(){var t=this.items.shift();return Graph.registry.shape.get(t)},t.prototype.unshift=function(t){return this.items.unshift(t),t},t.prototype.pull=function(t){var e=t.guid();_.pull(this.items,e)},t.prototype.last=function(){return _.last(this.items)},t.prototype.each=function(t){var e=this;_.forEach(e.items,function(e,r){var n=Graph.registry.shape.get(e);n&&t.call(n,n,r)})},t.prototype.bbox=function(){for(var t,e,r,n=[],i=[],o=[],s=[],a=this.items.length-1;a>=0;a--)t=Graph.registry.shape.get(this.items[a]),e=t.component(),r=e.bbox().toJson(),n.push(r.x),i.push(r.y),o.push(r.x+r.width),s.push(r.y+r.height);return n=_.min(n),i=_.min(i),o=_.max(o),s=_.max(s),Graph.bbox({x:n,y:i,x2:o,y2:s,width:o-n,height:s-i})},t.prototype.toArray=function(){
...
for(var r=this.index(t),n=this.nodes,i=this.nodes.length,o=0,s=r;s<i;s++)e(n[s],o),o++},t.prototype.bubble=function(t,e){for(var r=this.index(t),n=this.nodes,i=0,o=r;o>=0;o--)e(n[o],i),i++},t.prototype.toArray=function(){return this.nodes.slice()}}(),function(){var t=Graph.collection.Link=function(t){this.items=_.map(t,function(t){return t.guid()}),t=null};t.prototype.constructor=t,t.prototype.keys=function(){return this.items.slice()},t.prototype.size=function(){return this.items.length},t.prototype.index=function(t){var e=t.guid();return _.indexOf(this.items,e)},t.prototype.has=function(t){var e=t.guid();return-1!==_.indexOf(this.items,e)},t.prototype.find=function(t){var e=this.toArray();return _.find(e,t)},t.prototype.push=function(t){var e=this;return _.isArray(t)?_.forEach(t,function(t){var r=t.guid();e.items.push(r)}):e.items.push(t.guid()),e.items.length},t.prototype.pop=function(){var t=this.items.pop();return Graph.registry.link.get(t)},t.prototype.shift=function(){
...
onTransformerAfterTranslate:function(t){this.dirty(!0),this.fire("aftertranslate",{dx:t.dx,dy:t.dy})},onTransformerAfterScale:function(t){if(this.dirty(!0),this.props.scaleX=t.sx,this.props.scaleY=t.sy,this.fire("afterscale",{sx:t.sx,sy:t.sy}),this.plugins.dragger){var e=this.matrixCurrent().scale();this.plugins.dragger.scale(e.x,e.y)}},onRotatorAfterRotate:function(t){this.fire(t)},onActivateTool:function(t){var e=t.originalData;this.fire("activatetool",e)},onDeactivateTool:function(t){var e=t.originalData;this.fire("deactivatetool",e)}});n.guid=0,Graph.isVector=function(t){return t instanceof Graph.svg.Vector}}(),function(){Graph.svg.Ellipse=Graph.extend(Graph.svg.Vector,{constructor:function(t,e,r,n){this.superclass.prototype.constructor.call(this,"ellipse",{cx:t,cy:e,rx:r,ry:n})},shape:function(){var t=this.attrs;return Graph.path([["M",t.cx,t.cy],["m",0,-t.ry],["a",t.rx,t.ry,0,1,1,0,2*t.ry],["a",t.rx,t.ry,0,1,1,0,-2*t.ry],["z"]])},resize:function(t,e,r,n,i,o){
var s,a,p=this.graph.matrix.clone().scale(t,e,r,n),h=this.props.rotate,l=p.x(this.attrs.cx,this.attrs.cy),c=p.y(this.attrs.cx,this.attrs.cy),u=this.attrs.rx*t,d=this.attrs.ry*e;this.reset(),this.attr({cx:l,cy:c,rx:u,ry:d}),h&&this.rotate(h,l,c).commit();var f=this.bbox().toJson();return s=l-u-i,a=c-d-o,s=f.x,a=f.y,{matrix:p,translate:{dx:i,dy:o},scale:{sx:t,sy:e,cx:r,cy:n},rotate:{deg:h,cx:l,cy:c},magnify:{cx:s,cy:a}}},toString:function(){return"Graph.svg.Ellipse"}})}(),function(){Graph.svg.Circle=Graph.extend(Graph.svg.Vector,{constructor:function(t,e,r){var n=this;Graph.isPoint(t)&&(r=e,e=t.props.y,t=t.props.x),n.superclass.prototype.constructor.call(n,"circle",{cx:t,cy:e,r:r})},shape:function(){var t=this.attrs;return Graph.path([["M",t.cx,t.cy],["m",0,-t.r],["a",t.r,t.r,0,1,1,0,2*t.r],["a",t.r,t.r,0,1,1,0,-2*t.r],["z"]])},resize:function(t,e,r,n,i,o){var s,a,p,h=this.graph.matrix.clone(),l=this.props.rotate,c=this.attrs.cx,u=this.attrs.cy,d=this.attrs.r;return 1===e?(p=d*t,
e=t):1===t?(p=d*e,t=e):t<e?(p=d*e,t=e):t>e&&(p=d*t,e=t),h.scale(t,e,r,n),s=h.x(c,u),a=h.y(c,u),this.reset(),this.attr({cx:s,cy:a,r:p}),l&&this.rotate(l,s,a).commit(),{matrix:h,translate:{dx:i,dy:o},scale:{sx:t,sy:e,cx:r,cy:n},rotate:{deg:l,cx:s,cy:a}}},toString:function(){return"Graph.svg.Circle"}})}(),function(){Graph.svg.Rect=Graph.extend(Graph.svg.Vector,{constructor:function(t,e,r,n,i){var o=this;i=_.defaultTo(i,6),o.superclass.prototype.constructor.call(o,"rect",{x:_.defaultTo(t,0),y:_.defaultTo(e,0),rx:i,ry:i,width:_.defaultTo(r,0),height:_.defaultTo(n,0)}),o.origpath=o.shape()},attr:function(t,e){var r=this.superclass.prototype.attr.apply(this,[t,e]);return"rx"==t&&void 0!==e&&(this.attrs.r=this.attrs.rx),r},shape:function(){var t=this.attrs
;return t.r?Graph.path([["M",t.x+t.r,t.y],["l",t.width-2*t.r,0],["a",t.r,t.r,0,0,1,t.r,t.r],["l",0,t.height-2*t.r],["a",t.r,t.r,0,0,1,-t.r,t.r],["l",2*t.r-t.width,0],["a",t.r,t.r,0,0,1,-t.r,-t.r],["l",0,2*t.r-t.height],["a",t.r,t.r,0,0,1,t.r,-t.r],["z"]]):Graph.path([["M",t.x,t.y],["l",t.width,0],["l",0,t.height],["l",-t.width,0],["z"]])},resize:function(t,e,r,n,i,o){var s,a,p,h,l=this.matrix().clone(),c=l.rotate().deg;return l.scale(t,e,r,n),this.reset(),s=l.x(this.attrs.x,this.attrs.y),a=l.y(this.attrs.x,this.attrs.y),p=this.attrs.width*t,h=this.attrs.height*e,this.attr({x:s,y:a,width:p,height:h}),c&&this.rotate(c,s,a).commit(),{matrix:l,translate:{dx:i,dy:o},scale:{sx:t,sy:e,cx:r,cy:n},rotate:{deg:c,cx:s,cy:a}}},toString:function(){return"Graph.svg.Rect"}})}(),function(){Graph.svg.Path=Graph.extend(Graph.svg.Vector,{constructor:function(t){t||(t=[["M",0,0]]),
t=_.isArray(t)?Graph.path(Graph.util.segments2path(t)).absolute().toValue():t instanceof Graph.lang.Path?t.toValue():Graph.path(t).absolute().toValue(),this.superclass.prototype.constructor.call(this,"path",{d:t})},shape:function(){return Graph.path(this.attrs.d)},segments:function(){return this.shape().segments},intersection:function(t,e){return this.shape().intersection(t.shape(),e)},intersectnum:function(t){return this.shape().intersectnum(t.shape())},angle:function(){var t=_.clone(this.segments()),e=t.length-1;"Z"==t[e][0]&&(e--,t.pop()),1===t.length&&(e++,t.push(["L",t[0][1],t[0][2]]));var r=t[e][1]-t[e-1][1],n=t[e][2]-t[e-1][2];return(180+180*Math.atan2(-n,-r)/Math.PI+360)%360},slice:function(t,e){return this.shape().slice(t,e)},pointAt:function(t){return this.shape().pointAt(t)},length:function(){return this.shape().length()},addVertext:function(t){var e=this.shape();return e.addVertext(t),this.attr("d",e.command()),this},resize:function(t,e,r,n,i,o){
var s=this.matrix().clone(),a=matrix.rotate(),p=a.deg,h=a.rad,l=(Math.sin(h),Math.cos(h),this.shape()),c=l.segments,u=c[0][1],d=c[0][2];return p&&s.rotate(-p,u,d),u=s.x(c[0][1],c[0][2]),d=s.y(c[0][1],c[0][2]),s.scale(t,e,r,n),_.forEach(c,function(t){var e,r,n,i;"Z"!=t[0]&&(e=t[t.length-2],r=t[t.length-1],n=s.x(e,r),i=s.y(e,r),t[t.length-2]=n,t[t.length-1]=i)}),this.reset(),this.attr("d",l.command()),p&&this.rotate(p,u,d).commit(!0),{matrix:s,x:u,y:d}},moveTo:function(t,e){var r=this.shape();return r.moveTo(t,e),this.attr("d",r.command()),this},lineTo:function(t,e,r){var n=this.shape();return n.lineTo(t,e,r),this.attr("d",n.command()),this},tail:function(){var t=this.segments();return t.length?Graph.point(t[0][1],t[0][2]):null},head:function(){var t,e=this.segments();return e.length?(t=e.length-1,Graph.point(e[t][1],e[t][2])):null},toString:function(){return"Graph.svg.Path"}})}(),function(){Graph.svg.Polyline=Graph.extend(Graph.svg.Vector,{constructor:function(t){t=_.defaultTo(t,""),
